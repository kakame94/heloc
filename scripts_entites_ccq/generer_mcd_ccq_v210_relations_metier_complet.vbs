...
' ================================================================
' Script VBScript PowerDesigner - MCD CCQ v2.10 - COMPLET & RELATIONS MÉTIER
' ================================================================
...
Sub Main()
    ...
    model.Name = "CCQ v2.10 - Relations Métier Completes"
    model.Code = "CCQ_MCD_V210_METIER_FULL"
    
    Dim emplDoss, salarDoss, emplRel, rapMensEnt, rapMensDet, cfgConfig, cfgConfigParm
    Dim emplRelHistory, dcsal02Chadr, dcsal02Chinfoper, dcsal02Blocage
    ...
    Set attr = salarDoss.Attributes.CreateNew() : attr.Name = "Identifiant employeur préféré Salarié" : attr.Code = "EMP_PRF_DOSS_ID" : attr.DataType = "I"
    ...
    ' Colonnes de données (Miroir EMPL_REL)
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Code région administrative Historique" : attr.Code = "REG_ADMIN_CD" : attr.DataType = "VA2"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Nom entreprise Historique" : attr.Code = "ENTRP_NM" : attr.DataType = "VA200"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Code fonction Historique" : attr.Code = "FONCTION_CD" : attr.DataType = "VA50"
    ...
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Code province Historique" : attr.Code = "PROV_CD" : attr.DataType = "A2"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Code postal Historique" : attr.Code = "CP_CD" : attr.DataType = "VA7"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Pays Historique" : attr.Code = "PAYS_NM" : attr.DataType = "VA50"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Numéro téléphone Historique" : attr.Code = "TEL_NO" : attr.DataType = "VA20"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Courriel Historique" : attr.Code = "COURRIEL_ADR" : attr.DataType = "VA100"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Date naissance Historique" : attr.Code = "NAISS_DT" : attr.DataType = "D"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Code statut relation Historique" : attr.Code = "STATUT_REL_CD" : attr.DataType = "VA20"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Date traitement Historique" : attr.Code = "TRAIT_DT" : attr.DataType = "D" : attr.Mandatory = True
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Date dernier changement Historique" : attr.Code = "DERN_CHG_DT" : attr.DataType = "D"
    ...
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Numéro téléphone autre Historique" : attr.Code = "TEL_AUTRE_NO" : attr.DataType = "VA20"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Numéro fax Historique" : attr.Code = "FAX_NO" : attr.DataType = "VA20"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Note téléphone Historique" : attr.Code = "NOTE_TEL" : attr.DataType = "VA50"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Note téléphone autre Historique" : attr.Code = "NOTE_TEL_AUTRE" : attr.DataType = "VA50"
    
    ' Dates (Conservation des noms sources pour miroir exact)
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Date début validité Historique" : attr.Code = "DT_DEB_VALIDITE" : attr.DataType = "D"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Date fin validité Historique" : attr.Code = "DT_FIN_VALIDITE" : attr.DataType = "D"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Date insolvabilité Historique" : attr.Code = "DT_INSOLVABILITE" : attr.DataType = "D"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Date décès Historique" : attr.Code = "DT_DECES" : attr.DataType = "D"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Date décès présumé Historique" : attr.Code = "DT_PRESUME_DECES" : attr.DataType = "D"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Date début fonction Historique" : attr.Code = "DT_DEB_FONCTION" : attr.DataType = "D"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Date fin fonction Historique" : attr.Code = "DT_FIN_FONCTION" : attr.DataType = "D"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Date réception désignation Historique" : attr.Code = "DT_RECEP_DESIGNATION" : attr.DataType = "D"
    Set attr = emplRelHistory.Attributes.CreateNew() : attr.Name = "Date enregistrement désignation Historique" : attr.Code = "DT_ENR_DESIGNATION" : attr.DataType = "D"
    ...
    Set attr = dcsal02Chadr.Attributes.CreateNew() : attr.Name = "Numéro client salarié ChAdresse" : attr.Code = "CLIENT_SAL_NO" : attr.DataType = "VA10" : attr.Mandatory = True
    ...
    Set attr = dcsal02Chinfoper.Attributes.CreateNew() : attr.Name = "Numéro client salarié ChInfo" : attr.Code = "CLIENT_SAL_NO" : attr.DataType = "VA10" : attr.Mandatory = True
    ...
    Set attr = dcsal02Blocage.Attributes.CreateNew() : attr.Name = "Numéro client salarié Blocage" : attr.Code = "CLIENT_SAL_NO" : attr.DataType = "VA10" : attr.Mandatory = True
